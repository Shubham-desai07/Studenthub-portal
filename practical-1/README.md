...
RoleDescriptionStudentViews personal academic data, submits assignments, checks noticesFacultyManages assigned courses, marks attendance, uploads gradesAdminManages overall system data — users, courses, reports
